...
class Trainer:
    ...
    def __init__(self,
       ...
       #  self.scheduler = scheduler.LRScheduler(lr_decay=self.lr_decay,
        ...
        self.scheduler_d = torch.optim.lr_scheduler.CosineAnnealingLR(self.optD, self.num_steps)
        self.scheduler_g = torch.optim.lr_scheduler.CosineAnnealingLR(self.optG, self.num_steps)
