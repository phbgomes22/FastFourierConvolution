...
def main():
    ...
    parser.add_argument('--dir_dataset', type=str, default=os.path.join(dir, 'dataset_flowers'))
    parser.add_argument('--dir_logs', type=str, default=os.path.join(dir, 'logs_fgan_flowers'))
